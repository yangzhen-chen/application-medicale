...
int cherche_soigneur_dans_ordonancement(Index_Soigneur id_s,T_Ordonnancement* o);
 ...
 */
T_RendezVous* provided_ajouterRendezVous
(T_RendezVous* listeRdV,Index_Soigneur idSoi,Time dateDebutSouhaitee,Time dateFinSouhaitee,Time tempsDeplacement,char* desc);
/**
 * Fonction offerte.
 * @brief Modification d’ un rendez-vous médical pour un patient par une date,
 * le temps de déplacement ou une description nouvelle :
 * @param listeRdV une liste de Rendezvous laquelle ne doit pas être vide.
 * @param idSoi un identifiant d'un soigneur associé.
 * @param dateDebutSouhaitee la date de début souhaitée d'un RdV.
 * @param dateFinSouhaitee la date de fin souhaitée d'un RdV.
 ...
 * @param desc une discription brève.
 */
void provided_modifierRendezVous
 ...
 */
T_RendezVous* provided_supprimerRendezVous
(T_RendezVous* listeRdV,
 Index_Soigneur idSoi);
